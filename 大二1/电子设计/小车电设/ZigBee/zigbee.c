...
volatile extern struct BasicInfo Game;//储存比赛状态、时间、泄洪口信息
volatile extern struct CarInfo Car;//储存车辆信息
volatile extern struct PassengerInfo Passenger;//储存人员的信息、位置和送达位置
volatile extern struct PackageInfo Package[6];//储存防汛物资的信息
volatile struct FloodInfo Flood[5];//储存泄洪口位置信息
volatile extern struct ObstacleInfo Obstacle[8];//储存虚拟障碍信息
/***********************接口****************************/
